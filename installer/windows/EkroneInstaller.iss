...
#define AppSetupName 'Ekrone Desktop'
#define AppVersion '1.0.0'
#define AppPublisher 'Ekrone Network'
#define AppCopyright 'Copyright (C) Ekrone Dev 2023'
#define AppURL 'https://ekrone.eu'
#define UpdateURL 'https://github.com/ekronemaster/Ekrone-desktop/releases'
#define AppExe 'ekrone-desktop.exe'
#define AppComments 'Ekrone Wallet'
#define LicenseFile 'license.txt'

[Setup]
; -------------
; ekrone desktop setup
; -------------
...
Root: HKLM; Subkey: "Software\Microsoft\Windows\CurrentVersion\App Paths\EKRONE-GUI.exe"; Flags: deletekey
Root: HKLM; Subkey: "Software\WOW6432Node\Microsoft\Windows\CurrentVersion\Uninstall\Ekrone Wallet";  Flags: deletekey
...
Type: files; Name: "{code:OldVersionPath}\Ekrone Wallet website.url"
Type: files; Name: "{code:OldVersionPath}\EKRONE-GUI.exe"
...
Type: files; Name: "{commondesktop}\Ekrone Wallet.lnk"
Type: files; Name: "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Ekrone Wallet\Ekrone Wallet.lnk"
Type: files; Name: "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Ekrone Wallet\Ekrone Wallet Website.lnk"
Type: files; Name: "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Ekrone Wallet\Uninstall Ekrone Wallet.lnk"
Type: dirifempty; Name: "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Ekrone Wallet"
...
function InitializeEkroneDesktopSetup(): Boolean;
var
	V: string;
begin
	Result := true;

	if RegQueryStringValue(HKLM, 'Software\Microsoft\Windows\CurrentVersion\App Paths\EKRONE-GUI.exe', '', V) then
	begin
