...
void Updater::replyFinished (QNetworkReply *reply)
{
    ...
    else
    {
        ...
        if (ourVersion < remoteVersion) {
            ...
            if (QMessageBox::warning(nullptr, QObject::tr("New version available"), QObject::tr("There is an update available for the Ekrone.\nDo you want to download it now?"), QMessageBox::Ok, QMessageBox::Cancel) == QMessageBox::Ok) {
                QString link = "https://ekrone.eu/#wallet";
