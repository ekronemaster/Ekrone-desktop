...
// Copyright (c) 2017-2023 Ekrone Developers
...
int main(int argc, char* argv[]) {
    ...
    do {
        ...
        QApplication::setApplicationName("Ekrone");
        QApplication::setOrganizationName("XEKR");
        ...
        QPixmap splashImg(":/images/images/EkroneSplash.png");
        ...
        engine.load(QUrl(QStringLiteral("qrc:/qml/qml/Ekrone/UI/AppWindow.qml")));
        splash.hide();
