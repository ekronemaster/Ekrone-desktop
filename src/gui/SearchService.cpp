...
SearchService::SearchService(QObject* parent)
    : QObject(parent)
{
    SearchServiceProgressStateClass::registerQmlEnum("Ekrone.SearchService", 1, 0, "SearchServiceProgressState");
    SearchServiceSearchTypeClass::registerQmlEnum("Ekrone.SearchService", 1, 0, "SearchServiceSearchType");
...
void SearchService::startSearch()
{
    ...
    *query = "https://search.ekrone.org/search?";
